...
public class TC003_Campaign {
	...
	public static void main(String[] args) throws Throwable {
		...
		Assert.assertEquals(actualValue, campName, "Campaign: " +campName+" is NOT created");
		System.out.println("Campaign: " +campName+" is created successfully");
	}
		//driver.quit();
	}
